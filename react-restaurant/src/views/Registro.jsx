...
export default function Registro() {
    ...
    const handleSubmit = async e => {
        ...
        const datos = {
            ...
            password_confirmation: passwordConfirmationRef.current.value //Laravel lo espera con guin bajo
        }
        try {
            ...
            <div className='bg-white shadow-md rounded-md mt-10 px-5 py-10'>
                <form onSubmit={handleSubmit} noValidate >
                    ...
                    <div className="mb-4">
                        ...
                        <input type="password" id="password_confirmation" className='mt-2 w-full p-3 bg-gray-50' name="password_confirmation" placeholder='Repetir password' ref={passwordConfirmationRef} />
                    </div>
